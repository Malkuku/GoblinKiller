  ...
  <div class="world-status-bar">
    ...
    <div class="top-bar-controls">
      ...
      <div class="action-controls-group">
        ...
        <!-- 变量监控按钮 -->
        <div class="variable-control-group">
          <button class="control-icon variable-btn" @click="$emit('toggle-variable-panel')" title="变量监控">
...
.font-control-group, .log-control-group, .edit-control-group, .create-char-control-group, .variable-control-group { display: flex; align-items: center; background: rgba(0,0,0,0.6); padding: 4px; border-radius: 20px; border: 1px solid var(--c-border); }
.log-control-group, .edit-control-group, .create-char-control-group, .variable-control-group { padding: 0; }
...
.log-btn, .edit-btn, .create-char-btn, .variable-btn { position: relative; width: 36px; height: 36px; padding: 0; border-radius: 50%; color: var(--c-text-dim); }
.log-btn:hover, .edit-btn:hover, .create-char-btn:hover, .variable-btn:hover { color: var(--c-gold); }
